...
class City:
    def __init__(self, width, height):
        ...
        self.windows = [
            ...
            pygame.Rect(345, 470, 20, 20),
            pygame.Rect(395, 110, 20, 20),
            pygame.Rect(425, 110, 20, 20),
            pygame.Rect(455, 110, 20, 20),
            pygame.Rect(485, 110, 20, 20),
            pygame.Rect(395, 140, 20, 20),
            pygame.Rect(425, 140, 20, 20),
            pygame.Rect(455, 140, 20, 20),
            pygame.Rect(485, 140, 20, 20),
            pygame.Rect(395, 170, 20, 20),
            pygame.Rect(455, 170, 20, 20),
            pygame.Rect(485, 170, 20, 20),

            pygame.Rect(555, 115, 20, 20),
            pygame.Rect(582, 115, 20, 20),
            pygame.Rect(610, 115, 35, 20),

            pygame.Rect(555, 148, 35, 20),
            pygame.Rect(598, 148, 20, 20),
            pygame.Rect(625, 148, 20, 20),

            pygame.Rect(580, 181, 20, 20),
            pygame.Rect(610, 181, 35, 20),
        ...
        self.doors = [
            ...
            pygame.Rect(428, 170, 15, 30),
            pygame.Rect(555, 184, 15, 35),
        ...
        self.knobs = [
            ...
            pygame.Rect(438, 185, 3, 3),
            pygame.Rect(565, 200, 3, 3),
